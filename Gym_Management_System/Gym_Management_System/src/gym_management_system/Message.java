...
public class Message extends JFrame {
	...
	{				
		String sql="Select contact_no as'Numbers' from add_customer";
        try{
	...
	public Message() {
		...
		btnSend.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(p==0)
				{
					JOptionPane.showMessageDialog(null, "Messages are pending");
				}
				else {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {	 
					...
					String msz=textArea.getText();
                                        if(!Pattern.matches("^[0-9]{10}+$", phn_no.getText())) //&& tf5.length()==10
                                            {JOptionPane.showMessageDialog(null, "Invalid Contect Nomber......");}
					if(j.equals(""))
					{
