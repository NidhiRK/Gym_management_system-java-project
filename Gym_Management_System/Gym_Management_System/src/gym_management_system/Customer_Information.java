...
public class Customer_Information extends JFrame implements ActionListener {
    String x[] ={"Customer Id","Name","Father's name","Email","Address","Contact no","Payment Plan","Gender","Height","Weight","Remarks","Trainer name","catg.","Joining Date"};
    JButton bt;
    JPanel p1,p2,p3;
    JLabel l1,l2;
    JTextField tf1;
    Font f1,f;
    String y[][]= new String[50][15];
    int i=0,j=0;
    JTable t;
    ...
    {
        super("Fitness Center || Customer Information");
        setSize(1500,400);
        setLocation(1,1);
  ...
  {
      int recipt_no=Integer.parseInt(tf1.getText());
      if(e.getSource()==bt)
      {
          try
          {
            ConnectionClass obj1= new ConnectionClass();
            String q=" delete from add_customer where recipt_no='"+recipt_no+"' ";
