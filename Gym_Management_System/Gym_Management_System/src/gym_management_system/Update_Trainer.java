...
public class Update_Trainer extends JFrame implements  ActionListener{
    ...
    public Update_Trainer() {
        super("Fitness Center || Update Trainer");
        setSize(750, 700);
        setLocation(10, 10);
        setResizable(false);
...
//        p1.add(tf7);
        ...
        ch0.addMouseListener(new MouseAdapter()
        {
            ...
            ResultSet rest1= obj2.stm.executeQuery(query);
                    while (rest1.next()) {
                        ...
                        tf6.setText(rest1.getString("adhar_no"));
    ...
    public void actionPerformed(ActionEvent e)
    {
           ...
           try {
               ...
               String q= "update add_trainer set name='"+name+"',fname='"+fname+"',email='"+email+"',address='"+address+"',contact_no='"+cont+"',adhar_no='"+eno+"',catagory='"+tcat+"',min_agreement='"+minag+"',gender='"+gender+"',height='"+height+"',weight='"+weight+"',remarks='"+remarks+"' where tid='"+tid+"'";
