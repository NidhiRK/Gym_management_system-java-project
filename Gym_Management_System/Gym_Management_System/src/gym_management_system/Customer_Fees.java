...
public class Customer_Fees extends JFrame implements ActionListener{
    ...
    Customer_Fees()
    {
        super("Fitness Center || Custome Fees");
        setSize(670,300);
        setLocation(270,250);
        setResizable(false);
  ...
  ch1.addMouseListener(new MouseAdapter()
    {
        ...
        {
            int recipt_no= Integer.parseInt(ch1.getSelectedItem());
            try
            {
                ConnectionClass obj1 =new ConnectionClass();
                String q1= "select * from add_customer where recipt_no='"+recipt_no+"'";
                ResultSet rest1 = obj1.stm.executeQuery(q1);
                while(rest1.next())
                {
                    tf1.setText(rest1.getString("name"));
                    tf2.setText(rest1.getString("catagory"));
    ...
    {
        String recipt_no= ch1.getSelectedItem();
        String name=tf1.getText();
        String catagory=tf2.getText();
    ...
    try{
     ...
     if(e.getSource()==bt1)
            {
                ConnectionClass obj2= new ConnectionClass();
                String q2="insert into pay_customer values('"+recipt_no+"','"+name+"','"+catagory+"','"+fees+"','"+month+"','"+trainer_name+"')";
