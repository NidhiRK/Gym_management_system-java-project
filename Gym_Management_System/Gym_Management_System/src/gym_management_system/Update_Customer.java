...
public class Update_Customer extends JFrame implements ActionListener
{
    ...
    Update_Customer()
    {
        super("Fitness Center || Update Customer");
        setSize(750,700);
        setLocation(10,10);
        setResizable(false);
            ...
            public void mouseClicked(MouseEvent arg0)
            {
                try
                {
                    ...
                    while(rest1.next())
                    {
                        ...
                        tf5.setText(rest1.getString("contact_no"));
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        int reciptno=Integer.parseInt(ch6.getSelectedItem());
        ...
        String tname=ch5.getSelectedItem();
            ...
            if(e.getSource()==bt1)
            {
                ...
                String q="update add_customer set name='"+name+"',fname='"+fname+"',email='"+email+"',address='"+address+"',contact_no='"+cont+"',payment_plan='"+minag+"',gender='"+gender+"',height='"+height+"',weight='"+weight+"',remarks='"+remarks+"',trainer_name='"+tname+"',catagory='"+tcat+"' where recipt_no='"+reciptno+"' ";
