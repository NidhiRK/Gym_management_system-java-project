...
public class Add_Trainer extends JFrame implements  ActionListener{
    ...
    Font f1,f;
    public Add_Trainer() {
        super("Fitness Center || Trainer Add");
        setSize(750, 700);
        setLocation(10, 10);
        setResizable(false);
...
//              if ((tf1.getText()== null)  && (tf2.getText()== null) && (tf3.getText()== null))
               if ((tf1.getText().equals(""))|| (tf2.getText().equals("")) || (tf3.getText().equals("")) || (tf4.getText().equals("")) || (tf5.getText().equals(""))|| (tf6.getText().equals(""))|| (tf10.getText().equals("")))
              {  JOptionPane.showMessageDialog(null,"Please  Enter All Data......");}
              else{
                 
                   ConnectionClass obj = new ConnectionClass();
                  String q= "insert into add_trainer values('"+tid+"','"+name+"','"+fname+"','"+email+
                          "','"+address+"','"+cont+"','"+eno+"','"+tcat+"','"+minag+"','"+gender+"','"+height+"','"+weight+"','"+remarks+"','"+date+"')";
