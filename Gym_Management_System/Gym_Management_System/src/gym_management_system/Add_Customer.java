...
public class Add_Customer extends JFrame implements  ActionListener{
    ...
    Font f1,f;
    public Add_Customer() {
        super("Fitness Center || Customer add");
        setSize(750, 700);
        setLocation(10, 10);
        setResizable(false);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("gym_management_system/Icons/cus9.jpg"));
...
//    private void tf5KeyRelesed(java.awt.event.KeyEvent evt){
//        String cont = tf5.getText();
//        if(cont.matches("^[0-9]*$") && cont.length()==10)
//        {
...
//    }
    ...
    public void actionPerformed(ActionEvent e) {
        try {
          ...
          Matcher match =patt.matcher(tf1.getText());
          if(!match.matches()){
             {JOptionPane.showMessageDialog(this, "Incorect Name......");
             
           }
          
           if(!Pattern.matches("^[0-9]{10}+$", tf5.getText())) //&& tf5.length()==10
            {JOptionPane.showMessageDialog(this, "Invalid Contect Nomber......");
             tf5.setText("");
             tf5.grabFocus();
            }
            ...
            if (e.getSource() == bt3) {
                ...
                String q1 = " select * from add_trainer where catagory='Public'";
            ...
            if (e.getSource() == bt4) {
                ConnectionClass obj1 = new ConnectionClass();
                String q1 = " select * from add_trainer where catagory='Personal'";
                ResultSet rest1 = obj1.stm.executeQuery(q1);
                while (rest1.next()) {
                    ch5.add(rest1.getString("name"));
                }
...
//            String amount = tf11.getText();
            if(e.getSource()==bt1) 
            {
//              if ((tf1.getText()== null)  && (tf2.getText()== null) && (tf3.getText()== null)&& (tf4.getText()== null)  && (tf5.getText()== null)  && (tf10.getText()== null))
              if ((tf1.getText().equals(""))|| (tf2.getText().equals("")) || (tf3.getText().equals(""))|| (tf4.getText().equals(""))|| (tf5.getText().equals(""))|| (tf10.getText().equals("")))
              ...
              else
              {
                    ...
                    String q = "insert into add_customer values('"+id+"','"+name+"','"+fname+"','"+email+
                            "','"+address+"','"+cont+"','"+minag+"','"+gender+"','"+height+"','"+weight+"','"+remarks+"','"+tname+"','"+tcat+"','"+date+"')";
...
//               {
//
//                  JOptionPane.showMessageDialog(null,"NO data enterd......");
//              }
