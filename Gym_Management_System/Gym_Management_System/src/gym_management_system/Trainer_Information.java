...
public class Trainer_Information extends JFrame implements ActionListener {
    String x[] ={"Trainer Id","Name","Father's name","Email","Address","Contact no","Emg no","Catg.","Min aggrement","Gender","Height","Weight","Remarks","Joining Date"};
    JButton bt;
    JPanel p1,p2,p3;
    JLabel l1,l2;
    JTextField tf1;
    ...
    Trainer_Information()
    {
        super("Fitness Center || Trainer Information");
        setSize(1500,400);
        setLocation(0,1);
        ...
        try
        {
            ...
            while (rest.next())
            {
                ...
                y[i][j++]=rest.getString("min_agreement");
