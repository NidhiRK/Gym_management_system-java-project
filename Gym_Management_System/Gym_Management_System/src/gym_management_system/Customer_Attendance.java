...
public class Customer_Attendance extends JFrame implements ActionListener
{
    ...
    Customer_Attendance(){
        super("Fitness Center || Customer attendance");
        setLocation(70,10);
        setSize(400,250);
        setResizable(false);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String take_atte = ch2.getSelectedItem();
        String date = new  java.util.Date().toString();
        if (e.getSource()==bt1){
            try {
                ConnectionClass obj1 = new ConnectionClass();
                String q1 = "insert into customer_attendance values('"+receipt_no+"','"+select_time+"','"+take_atte+"','"+date+"')";
