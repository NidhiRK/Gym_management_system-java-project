...
//        p1.add(tf7);
        ...
        ch0.addMouseListener(new MouseAdapter()
        {
            ...
            ResultSet rest1= obj2.stm.executeQuery(query);
                    while (rest1.next()) {
                        ...
                        tf6.setText(rest1.getString("emergency_no"));
    ...
    public void actionPerformed(ActionEvent e)
    {
           ...
           try {
               ...
               String q= "update add_trainer set name='"+name+"',fname='"+fname+"',email='"+email+"',address='"+address+"',contact_no='"+cont+"',emergency_no='"+eno+"',catagory='"+tcat+"',min_agreement='"+minag+"',gender='"+gender+"',height='"+height+"',weight='"+weight+"',remarks='"+remarks+"' where tid='"+tid+"'";
